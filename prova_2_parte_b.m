...
saveas(figure(1), 'images/prova_2_parte_b_exercise_1_histogram_norm_1.fig');
saveas(figure(1), 'images/prova_2_parte_b_exercise_1_histogram_norm_1.png');

x_inf = inf_norm_optimization(A, b);
r_inf = A * x_inf - b;
...
saveas(figure(2), 'images/prova_2_parte_b_exercise_1_histogram_norm_inf.fig');
saveas(figure(2), 'images/prova_2_parte_b_exercise_1_histogram_norm_inf.png');
